...
demo_data <- read_xpt("raw data/15-16/DEMO_I.XPT")
...
cholesterol_data_total <- read_xpt("raw data/15-16/TCHOL_I.XPT")
cholesterol_data_HDL <- read_xpt("raw data/15-16/HDL_I.XPT")
...
bp_data <- read_xpt("raw data/15-16/BPX_I.XPT")
...
bp_med_data <- read_xpt("raw data/15-16/BPQ_I.XPT")
...
# Diabetes Data
# Used in ASCVD scores
diabetes_data <- read_xpt("raw data/15-16/DLQ_I.XPT")

# Select and rename relevant columns
diabetes_data <- diabetes_data %>% 
  select(SEQN, DLQ010) %>% 
  rename(PatientID = SEQN, Diabetes = DLQ010)
...
# Smoking Status Data
# Used in ASCVD scores
smoking_data <- read_xpt("raw data/15-16/SMQ_I.XPT")
...
```{r}
# CVD Data
cvd_data <- read_xpt("raw data/15-16/MCQ_I.XPT")
cvd_data <- cvd_data %>% 
